...
export const Navbar: React.FC<NavbarProps> = ({ onOpenBooking }) => {
  ...
  const navLinks = [
    ...
    { name: "Destinations", href: "#destinations", id: "destinations", hasDropdown: true },
    { name: "Programs", href: "#programs", id: "programs", hasDropdown: true },
    { name: "Universities", href: "#universities", id: "universities", hasDropdown: true },
    { name: "Scholarships", href: "#scholarships", id: "scholarships", hasDropdown: false },
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="bg-[#003875] text-white text-xs py-2 px-4 sm:px-6 lg:px-8 border-b border-white/10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 font-medium">
            ...
            <span>
              <strong className="text-amber-300">100% Scholarship</strong> Opportunities Available for International Students
            </span>
          </div>
      ...
      {/* 2. Main Navigation Bar (Clean White, Sticky) */}
      <div
